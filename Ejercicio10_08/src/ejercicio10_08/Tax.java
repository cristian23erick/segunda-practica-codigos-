...
class Tax {
	...
	// Construir un objeto de impuesto con el valor predeterminado
        // clasificaciónStatus, tasas, paréntesis y impuestos
	Tax() {
		
               // Estado de presentación de Defalut
		filingStatus = SINGLE_FILER;

		//Tasas impositivas del defalto
		double[] currentYearRates = {10, 15, 25, 28, 33, 35};;
		setRates(currentYearRates);

		//Corchetes por defecto para cada tasa para todos los estados de presentación
