...
public class Ejercicio10_08 {
    ...
    public static void main(String[] args) {
          // Crea dos objetos tax 
		Tax tax2001 = new Tax();
		Tax tax2009 = new Tax(); // Año corriente

		// Tax las tasas para 2001
		double[] rates2001 = {15, 27.5, 30.5, 35.5, 39.1};
		tax2001.setRates(rates2001);

		// Los corchetes de 2001 para cada tasa para todos los estados de presentación
		int[][] brackets2001 = {
